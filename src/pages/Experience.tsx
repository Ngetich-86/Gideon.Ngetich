                ...
                {ExperienceData.map((experience) => {
                    return (
                        <div key={experience.id} className='flex bg-gray-800 w-full md:w-[48%] 2xl:w-[40%]  p-4 cursor-pointer transform transition duration-300 hover:-translate-y-1 gap-4 rounded-lg'>
                            ...
                            <div className='w-[90%]'>
                                <h5 className='text-green-500 flex flex-col md:flex-row justify-between'><b>{experience.title}</b> <span className="text-text-light text-sm md:text-xs">{experience.period}</span></h5>
