...
//   return (
//     <div id='contact'>
//       <h1 className='text-xl md:text-4xl font-bold text-center pt-10 pb-10'>Contact Me 📲 </h1>
...
export const Contact = () => {
  const [formData, setFormData] = useState({
    from_name: '', // Updated from 'name' to 'from_name' for EmailJS compatibility
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    emailjs
      .send('service_fldy00m', 'template_kp365vm', formData, 'bI87WSZrvkdxgo4u7')
      .then(
        () => {
          toast.success('Message sent successfully!', {
            position: 'bottom-right',
      ...
      <div className="flex flex-col md:flex-row p-5 justify-center items-center h-fit gap-4 md:gap-8 pb-10 text-text-light">
        ...
        <div className="flex flex-col w-full md:w-[50%] shadow-lg p-5 rounded-lg justify-center">
          ...
          <form className="flex flex-col space-y-4" onSubmit={handleSubmit}>
            <input
              type="text"
              name="from_name" // Match the template variable in EmailJS
