                    ...
                    <div key={project.id} className='flex flex-col justify-center items-center bg-gray-800 w-full md:w-[30%] h-[550px] md:h-[500px] gap-5 cursor-pointer transform transition duration-300 hover:-translate-y-1 rounded-lg '>
                        ...
                        <div className='text-xl leading-8 p-4'>
                            ...
                            <div className='flex justify-around'>
                                <a href={project.github} target="_blank" rel="noopener noreferrer" className='block  rounded-lg p-2 text-base bg-[#00df9893] hover:bg-white hover:text-black transition duration-300 ' >
                                    Live Link
                                </a>
                                <a href={project.github} target="_blank" rel="noopener noreferrer" className='block rounded-lg p-2 text-base border-solid border-2 border-white-600  hover:border-[#00df9893] transition duration-300 ' style={{ width: 'fit-content ' }}>
                                    GitHub
                                </a>
                            </div>
                        </div>
